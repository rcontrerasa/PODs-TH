...
Instalar la extensión Tampermonkey desde este enlace
Administrar extensiones accediendo a extensiones
Habilitar "Modo de desarrollador" y "Permitir el acceso a las URL del archivo"
(Opcional): "Fijar en la barra de herramientas"
Importa el archivo Script_Tampermonkey-CCNx.js en options > utils o en este enlace
